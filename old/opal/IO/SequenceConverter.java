...
public class SequenceConverter {
	...
	public static int[][] convertSeqsToInts (char[][] seqs) {
	...
	public static char[][] convertIntsToSeqs (int[][] seqs) {
...
//		char[][] converted = new char[alignment.length][alignment[0].length];
	...
	public static char[][] convertPathToCharAlignment (ArrayList<Aligner.Direction> path, char[][] A, char[][] B) {
		int K = A.length;
		int L = B.length;
...
//		   Integer direc = (Integer)iter.next();
	...
	public static int[][] convertPathToIntAlignment (ArrayList<Aligner.Direction> path, Alignment A, Alignment B) {
		int K = A.K;
		int L = B.K;
...
//		   Integer direc = (Integer)iter.next();
	...
	public static int[][] buildReverseAlignment (int[][] A){
		int K = A.length;
		int N = A[0].length;
		int[][] rev = new int[K][N];
		for (int i=0; i<K; i++){
