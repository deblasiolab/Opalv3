...
public class Alignment {
	...
	public Alignment (int[] A, int id) { // single sequence		
		K = 1;
		seqs = new int[1][];
		seqs[0] = A;
		seqIds = new int[1];
	...
	public Alignment (int[][] A, int[] ids, boolean isReverse) {
	...
	public Alignment (int[][] A, int[] ids) {
		this(A, ids, false);
	}
	...
	public static Alignment buildNewAlignment (int[] seq, int seqId) {
		if (Aligner.useStructure)
			return new StructureAlignment(seq, seqId);
		else
			return  new Alignment(seq, seqId);
	}	

	public static Alignment buildNewAlignment (int[][] seqs, int[] seqIds, boolean isReverse) {
		if (Aligner.useStructure)
			return new StructureAlignment(seqs, seqIds, isReverse);
		else
			return  new Alignment(seqs, seqIds, isReverse);
	}
	
	public static Alignment buildNewAlignment (int[][] seqs, int[] seqIds) {
		return buildNewAlignment(seqs, seqIds, false);
	}	
}
