	...
	final public void polish ( int reps ) {
		...
		if (verbosity>0) {
			...
			if (AlignmentMaker.showCost) {
				prevCost = Aligner.calcCost(fullAlignment, alignment.seqIds);
...
//			split out 3 alignments
			...
			Alignment alA = Alignment.buildNewAlignment(Alignment.getDegappedCopy(A), idsA);
			Alignment alB = Alignment.buildNewAlignment(Alignment.getDegappedCopy(B), idsB);
			Alignment alC = Alignment.buildNewAlignment(Alignment.getDegappedCopy(C), idsC);
			Alignment alAB = Alignment.buildNewAlignment(Alignment.getDegappedCopy(AB), idsAB);
			Alignment alAC = Alignment.buildNewAlignment(Alignment.getDegappedCopy(AC), idsAC);
			Alignment alBC = Alignment.buildNewAlignment(Alignment.getDegappedCopy(BC), idsBC);
			...
			long AB_cost = Aligner.calcCost(AB, sizeA, sizeB, idsAB);  
			long AC_cost = Aligner.calcCost(AC, sizeA, sizeC, idsAC);
			long BC_cost = Aligner.calcCost(BC, sizeB, sizeC, idsBC);
