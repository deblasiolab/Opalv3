...
//	boolean testing = true;
	...
	protected void fillBoundary() {
		...
		H[0][1] = config.lambdaTerm*K*B.f1[1] + config.gammaTerm*K*B.firstLetterCount[1];
		V[1][0] = config.lambdaTerm*L*A.f1[1] + config.gammaTerm*L*A.firstLetterCount[1];
		D[0][0] = 0; 
		for (int j=2; j<=N; j++) {
			H[0][j] = H[0][j-1] + config.lambdaTerm*K*B.f1[j] + config.gammaTerm*K*B.firstLetterCount[j];
			D[0][j] = V[0][j] = bigNumber;
		}
		for (int i=2; i<=M; i++) {
			V[i][0] = V[i-1][0] + config.lambdaTerm*L*A.f1[i] + config.gammaTerm*L*A.firstLetterCount[i];
		...
		for (int i=1; i<=M; i++){
			for (int j=1; j<=N; j++){				
				...
				if (isPessimistic) {
					...
					x = H[i][j-1] + config.gamma*( (K * B.f01[j])- (begGapOpenCount_H+endGapOpenCount_H_pess) ) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_H_pess);
					y = V[i][j-1] + config.gamma*( (K * B.f1[j]) - (begGapOpenCount_H+endGapOpenCount_Hv_pess) ) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_Hv_pess);
					z = D[i][j-1] + config.gamma*( (fA1fB1 + A.f0[i]*B.f01[j]) -(begGapOpenCount_H+endGapOpenCount_Hd_pess) ) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_Hd_pess);
					if (config.useStructure) {
					...
					x = H[i-1][j] + config.gamma*( (L * A.f1[i])-(begGapOpenCount_V+endGapOpenCount_Vh_pess) ) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_Vh_pess);
					y = V[i-1][j] + config.gamma*( (L * A.f01[i])-(begGapOpenCount_V+endGapOpenCount_V_pess) ) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_V_pess);
					z = D[i-1][j] + config.gamma*( (fA1fB1 + A.f01[i]*B.f0[j])-(begGapOpenCount_V+endGapOpenCount_Vd_pess)) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_Vd_pess);
					if (config.useStructure) {
					...
					x = H[i-1][j-1] + config.gamma*( (A.f1[i]*B.f0[j] + A.f0[i]*B.f01[j])-(begGapOpenCount_D+endGapOpenCount_Dh_pess)) + config.gammaTerm*(begGapOpenCount_D+endGapOpenCount_Dh_pess);
					y = V[i-1][j-1] + config.gamma*( (B.f1[j]*A.f0[i] + B.f0[j]*A.f01[i])-(begGapOpenCount_D+endGapOpenCount_Dv_pess)) + config.gammaTerm*(begGapOpenCount_D+endGapOpenCount_Dv_pess);
					z = D[i-1][j-1] + config.gamma*( (A.f1[i]*B.f10[j] + A.f10[i]*B.f1[j] + A.f00[i]*B.f01[j] + A.f01[i]*B.f00[j] ) - (begGapOpenCount_D+endGapOpenCount_Dd_pess))
						+ config.gammaTerm*(begGapOpenCount_D+endGapOpenCount_Dd_pess);
					if (config.useStructure) {
					...
					x = H[i][j-1] + config.gammaTerm*begGapOpenCount_H;
					y = V[i][j-1] + config.gamma * (fA1fB1 - (begGapOpenCount_H+endGapOpenCount_H_opt)) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_H_opt);
					z = D[i][j-1] + config.gamma * (fA1fB1 - (begGapOpenCount_H+endGapOpenCount_H_opt)) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_H_opt);
					if (config.useStructure) {
						x += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.horiz, Direction.horiz, isPessimistic); 
						y += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.horiz, Direction.vert, isPessimistic); 
						z += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.horiz, Direction.diag, isPessimistic); 
					...
					x = H[i-1][j] + config.gamma * (fA1fB1 - (begGapOpenCount_V+endGapOpenCount_V_opt)) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_V_opt);
					y = V[i-1][j] + config.gammaTerm*begGapOpenCount_V;
					z = D[i-1][j] + config.gamma * (fA1fB1 - (begGapOpenCount_V+endGapOpenCount_V_opt)) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_V_opt);
					if (config.useStructure) {
						x += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.vert, Direction.horiz, isPessimistic); 
						y += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.vert, Direction.vert, isPessimistic); 
						z += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.vert, Direction.diag, isPessimistic); 
					...
					x = H[i-1][j-1] + config.gamma*(A.f1[i]*B.f10[j] + vTermGapOpens_notFirstCol - (begGapOpenCount_V + endGapOpenCount_Dh_opt)) + config.gammaTerm*(begGapOpenCount_D + endGapOpenCount_Dh_opt);
					y = V[i-1][j-1] + config.gamma*(B.f1[j]*A.f10[i] + hTermGapOpens_notFirstCol - (begGapOpenCount_H + endGapOpenCount_Dv_opt)) + config.gammaTerm*(begGapOpenCount_D + endGapOpenCount_Dv_opt);
					z = D[i-1][j-1] + config.gamma*(A.f1[i]*B.f10[j] + A.f10[i]*B.f1[j] + vTermGapOpens_notFirstCol + hTermGapOpens_notFirstCol- (begGapOpenCount_D + endGapOpenCount_Dd_opt)) + config.gammaTerm*(begGapOpenCount_D + endGapOpenCount_Dd_opt);
					if (config.useStructure) {
						x += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.diag, Direction.horiz, isPessimistic); 
						y += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.diag, Direction.vert, isPessimistic); 
						z += getStructGapOpenModifer((StructureAlignment)A, (StructureAlignment)B, i, j, Direction.diag, Direction.diag, isPessimistic); 
				...
				H[i][j] += config.lambda * (K*B.f1[j] - termGapExtCount_H) + config.lambdaTerm * termGapExtCount_H;
				V[i][j] += config.lambda * (L*A.f1[i] - termGapExtCount_V) + config.lambdaTerm * termGapExtCount_V; 
...
//				all substitution letter combos
				...
				D[i][j] += config.lambda * ( (A.f0[i] * B.f1[j] + A.f1[i] * B.f0[j])-termGapExtCount_D) + 
						config.lambdaTerm * termGapExtCount_D;
	...
	protected boolean recover () {
		...
		while (i>0 && j>0) {			
			...
			if (Direction.horiz == dir){
				...
				int base = config.lambda * (K*B.f1[j] - termGapExtCount_H) + config.lambdaTerm * termGapExtCount_H;
				if (config.useStructure) {
				...
				if ( cost == H[i][j-1] + base + x + ( isPessimistic ?  config.gamma * ( (K * B.f01[j])-(begGapOpenCount_H+endGapOpenCount_H_pess)) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_H_pess) : config.gammaTerm*begGapOpenCount_H )) {				
					nextdir = Direction.horiz;
					if (testing) LogWriter.stdOutLogln("hh(" + i + "," + j+ "): " + (cost));
				} else if ( cost == V[i][j-1] + base + y + (isPessimistic ? config.gamma * ( (K * B.f1[j])-(begGapOpenCount_H+endGapOpenCount_Hv_pess) ) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_Hv_pess): config.gamma * (fA1fB1 - (begGapOpenCount_H+endGapOpenCount_H_opt)) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_H_opt) ) ) {
					nextdir = Direction.vert;
					if (testing) LogWriter.stdOutLogln("vh(" + i + "," + j+ "): " + (cost));
				} else if ( cost == D[i][j-1] + base + z + (isPessimistic ? config.gamma * ( (A.f1[i]*B.f1[j] + A.f0[i]*B.f01[j])-(begGapOpenCount_H+endGapOpenCount_Hd_pess)) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_Hd_pess) : config.gamma * (fA1fB1 - (begGapOpenCount_H+endGapOpenCount_H_opt)) + config.gammaTerm*(begGapOpenCount_H+endGapOpenCount_H_opt)  )) {				
				...
				int base = config.lambda * (L*A.f1[i] - termGapExtCount_V) + config.lambdaTerm * termGapExtCount_V;
				if (config.useStructure) {
				...
				if ( cost == H[i-1][j] + base + x +  ( isPessimistic? config.gamma*( (L * A.f1[i])-(begGapOpenCount_V+endGapOpenCount_Vh_pess) ) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_Vh_pess) : config.gamma * (fA1fB1 - (begGapOpenCount_V+endGapOpenCount_V_opt)) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_V_opt) )) {
					nextdir = Direction.horiz;
					if (testing) LogWriter.stdOutLogln("hv(" + i + "," + j+ "): " + (cost));
				} else if ( cost == V[i-1][j] + base + y + ( isPessimistic ? config.gamma*( (L * A.f01[i])-(begGapOpenCount_V+endGapOpenCount_V_pess) ) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_V_pess) : config.gammaTerm*begGapOpenCount_V )) {				
					nextdir = Direction.vert;
					if (testing) LogWriter.stdOutLogln("vv(" + i + "," + j+ "): " + (cost));
			 	} else if ( cost == D[i-1][j] + base + z +  ( isPessimistic ? config.gamma*( (fA1fB1 + A.f01[i]*B.f0[j])-(begGapOpenCount_V+endGapOpenCount_Vd_pess) ) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_Vd_pess) : config.gamma * (fA1fB1 - (begGapOpenCount_V+endGapOpenCount_V_opt)) + config.gammaTerm*(begGapOpenCount_V+endGapOpenCount_V_opt) )) {					
					nextdir = Direction.diag;
				...
				int base = config.lambda * ( (A.f0[i] * B.f1[j] + A.f1[i] * B.f0[j])-termGapExtCount_D) 
								+ config.lambdaTerm * termGapExtCount_D;
				...
				if ( cost == H[i-1][j-1] + base + x + ( isPessimistic ? config.gamma * ((A.f1[i]*B.f0[j] + A.f0[i]*B.f01[j])-(begGapOpenCount_D+endGapOpenCount_Dh_pess)) + config.gammaTerm*(begGapOpenCount_D+endGapOpenCount_Dh_pess) : config.gamma*(A.f1[i]*B.f10[j] + vTermGapOpens_notFirstCol - (begGapOpenCount_V+endGapOpenCount_Dh_opt)) + config.gammaTerm*(begGapOpenCount_D + endGapOpenCount_Dh_opt) )) {				
					nextdir = Direction.horiz;
					if (testing) LogWriter.stdOutLogln("hd(" + i + "," + j+ "): " + (cost));
				} else if ( cost == V[i-1][j-1] + base + y + ( isPessimistic ? config.gamma * ( (B.f1[j]*A.f0[i] + B.f0[j]*A.f01[i])-(begGapOpenCount_D+endGapOpenCount_Dv_pess)) + config.gammaTerm*(begGapOpenCount_D+endGapOpenCount_Dv_pess) : config.gamma*(B.f1[j]*A.f10[i] + hTermGapOpens_notFirstCol - (begGapOpenCount_H+endGapOpenCount_Dv_opt)) + config.gammaTerm*(begGapOpenCount_D + endGapOpenCount_Dv_opt) )) {				
					nextdir = Direction.vert;		
					if (testing) LogWriter.stdOutLogln("vd(" + i + "," + j+ "): " + (cost));
				} else if ( cost == D[i-1][j-1] + base + z + ( isPessimistic ? config.gamma * ( (A.f1[i]*B.f10[j] + A.f10[i]*B.f1[j] + A.f00[i]*B.f01[j] + A.f01[i]*B.f00[j])-(begGapOpenCount_D+endGapOpenCount_Dd_pess)) + config.gammaTerm*(begGapOpenCount_D+endGapOpenCount_Dd_pess) : config.gamma*( A.f1[i]*B.f10[j] + A.f10[i]*B.f1[j] + vTermGapOpens_notFirstCol + hTermGapOpens_notFirstCol- (begGapOpenCount_D+endGapOpenCount_Dd_opt)) + config.gammaTerm*(begGapOpenCount_D + endGapOpenCount_Dd_opt) )) {									 
					nextdir = Direction.diag;
